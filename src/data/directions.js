...
export const directionsData = [
  // --- STRETCHING ---
  {
    ...
    tag: "Movement",
    hero: {
      image: "/images/directions/stretching/hero.jpg",
      title: "STRETCHING",
    ...
    intro: {
      imageLeft: "/images/directions/stretching/intro.jpg",
  ...
  tag: "MOVEMENT",
  hero: {
    image: "/images/directions/strip-plastic/hero.jpg",
    title: "Стрип пластика",
    subtitle: "Пластика, хореография и уверенность в движении",
    ctaText: "ЗАПИСАТЬСЯ НА ПРОБНОЕ ЗАНЯТИЕ",
    ctaHref: "tel:+998933775697"
  },
  intro: {
    imageLeft: "/images/directions/strip-plastic/intro.jpg",
    title: "Танцевальное направление для пластики и самовыражения",
    text: "На занятиях работаем над грацией, координацией, музыкальностью и уверенностью в себе."
  },
  benefitsBlock: {
    title: "Основные преимущества Стрип пластики",
    items: [
      { title: "Пластика", text: "Развивает мягкость и выразительность движений." },
      { title: "Осанка", text: "Помогает лучше чувствовать корпус и держать линию." },
      { title: "Уверенность", text: "Раскрывает женственность и свободу самовыражения." },
      { title: "Координация", text: "Улучшает чувство ритма и контроль тела." }
    ]
  },
  prepareSteps: [
    { n: 1, title: "Форма", text: "Удобная одежда, не сковывающая движения." },
    { n: 2, title: "Обувь", text: "Носки, чешки или по рекомендациям тренера." },
    { n: 3, title: "Настрой", text: "Приходите за уверенностью, пластикой и удовольствием." }
  ],
  studios: ["st-aly"],
  gallery: [
    "/images/directions/strip-plastic/g1.jpg",
    "/images/directions/strip-plastic/g2.jpg",
    "/images/directions/strip-plastic/g3.jpg"
  ],
  seo: {
