...
export const directionsData = [
  ...
  },
  {
    ...
    hero: {
      ...
      title: "Похудейка",
      subtitle: "Кардио + силовые — безопасное снижение веса",
      ctaText: "ЗАПИСАТЬСЯ НА ПРОБНОЕ ЗАНЯТИЕ",
      ctaHref: "tel:+998933775697"
    },
    intro: {
    ...
    benefitsBlock: {
      ...
      items: [
        ...
        { title: "Мотивация", text: "Групповой формат и поддержка." },
  ...
  },
  {
    ...
    benefitsBlock: {
      ...
      items: [
        ...
        { title: "Калории", text: "Интенсивное кардио без ударов." },
  ...
  },
  {
    ...
    benefitsBlock: {
      ...
      items: [
        ...
        { title: "Кардио", text: "Связки на музыку." },
  ...
  },
  {
    ...
    prepareSteps: [
      ...
      { n: 2, title: "Аксессуары", text: "Блоки/ремень при необходимости." },
      { n: 3, title: "Режим", text: "Лёгкий перекус до практики." }
    ],
    studios: ["st-aly","st-alm"],
    gallery: [
  ...
  },
  {
    ...
    hero: {
      ...
      title: "Аэройога",
      subtitle: "Практика в гамаках для декомпрессии и гибкости",
      ctaText: "ЗАПИСАТЬСЯ НА ПРОБНОЕ ЗАНЯТИЕ",
      ctaHref: "tel:+998933775697"
    },
    intro: {
  ...
  },
  {
    ...
    intro: {
      ...
      text: "Поддержка гамаком позволяет безопасно углубляться в асаны."
    },
    benefitsBlock: {
