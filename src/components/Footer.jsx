...
import { Instagram, Facebook } from "../lib/icons.jsx";
        ...
        <div className="max-w-7xl mx-auto grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="text-sm text-white/80 space-y-2">
              ...
              <li><a href="/about" className="hover:text-scarlet">Команда</a></li>
              <li><a href="/massage" className="hover:text-scarlet">Массаж</a></li>
           
              <li><a href="/akcii" className="hover:text-scarlet">Акции</a></li>
            </ul>
          </div>
            ...
            <div>
              ...
              <div className="mt-4 flex items-center gap-3">
                <a
                  ...
                  aria-label="Telegram"
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full border-2 border-white hover:bg-white/10 transition"
                >
                  <Send size={18} />
                </a>
                <a
                ...
                {/* Иконку Facebook оставил в импорте на случай будущего использования */}
              </div>
            </div>
          </div>
        </div>
