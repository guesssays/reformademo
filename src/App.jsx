...
import PromosPage from "./pages/Promos.jsx"; // ← ДОБАВИЛ
    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout />}>
          ...
          {/* Страница расписания и цен (основной URL) */}
          <Route path="raspisanie-i-ceny" element={<PricesPage />} />

          {/* Алиасы на всякий случай */}
          <Route path="prices" element={<PricesPage />} />
          <Route path="pricing" element={<PricesPage />} />
          <Route path="schedule" element={<PricesPage />} />
          <Route path="raspisanie" element={<PricesPage />} />

          {/* Новая страница «Акции» */}
          <Route path="akcii" element={<PromosPage />} />
